...
procedure TCMI.FormActivate(Sender: TObject);
begin
memo1.lines.LoadFromFile('text_files\cmi.txt');
kol:=sg1.ColCount-1;
button1.Click;
end;

procedure TCMI.Button1Click(Sender: TObject);
...
procedure TCMI.Button2Click(Sender: TObject);
begin
CMI.close;
end;
